...
- **`skills/iv/SKILL.md`** — `/iv` slash command: generates inline Python for IV calculation.
- **`skills/iv-enhanced/SKILL.md`** — `/iv-enhanced` slash command: directly invokes `options_vol_calculator.py` CLI (faster, no code generation).
